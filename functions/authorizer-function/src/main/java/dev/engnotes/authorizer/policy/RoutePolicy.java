...
public final class RoutePolicy {
    ...
    private static final List<Rule> RULES = List.of(
            ...
            new Rule("GET", "analysis/*", Set.of("readers", "premium", "admins")),
            ...
            new Rule("GET", "portfolio", Set.of("premium", "admins")),
            new Rule("GET", "portfolio/*", Set.of("premium", "admins")),
            new Rule("POST", "portfolio/*", Set.of("premium", "admins")),
            new Rule("DELETE", "portfolio/*", Set.of("premium", "admins")),
