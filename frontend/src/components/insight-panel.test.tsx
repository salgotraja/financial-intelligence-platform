...
describe('InsightPanel', () => {
  it('renders a found insight with drivers', () => {
    render(<InsightPanel insight={insight} />)
  ...
  it('renders an empty state when not found', () => {
    render(<InsightPanel insight={{ ...insight, found: false, signal: null }} />)
  ...
  it('omits the model id for a rule-based fallback', () => {
    render(<InsightPanel insight={{ ...insight, source: 'RULE_BASED', modelId: 'model-x' }} />)
